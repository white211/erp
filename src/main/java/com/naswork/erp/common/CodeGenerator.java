...
/**
 * @Program: MysqlGenerator
 * @Description:
 * @Author: White
 * @DateTime: 2018-11-22 11:21:22
 **/

public class CodeGenerator {

    private static String packageName="erp";    //文件路径
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("root")
                        .setUrl("jdbc:mysql://localhost:3306/jmi?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
...
//                        .setModuleName(scanner("模块名"))
                        .setParent("com.naswork."+packageName)// 自定义包路径
